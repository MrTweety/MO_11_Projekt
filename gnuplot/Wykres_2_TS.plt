...
set output "A_TS_Wykres2_i50.png"
...
plot 'rozwA50.txt'  using 2:3 with lines title "Analityczne",\
 'rozwT50.txt'  using 2:3 with   points pt 2 lc 3 title "Thomasa",\
 'rozwSOR50.txt'  using 2:3 with  points pt 1 lc 2 title "SOR",\
...
set xrange [-10:10]
set terminal png size 1366,768
set output "A_TS_Wykres2_i100.png"
...
plot 'rozwA100.txt'  using 2:3 with lines title "Analityczne",\
 'rozwT100.txt'  using 2:3 with   points pt 2 lc 3 title "Thomasa",\
 'rozwSOR100.txt'  using 2:3 with  points pt 1 lc 2 title "SOR",\
...
set xrange [-10:10]
set terminal png size 1366,768
set output "A_TS_Wykres2_i150.png"
...
plot 'rozwA150.txt'  using 2:3 with lines title "Analityczne",\
 'rozwT150.txt'  using 2:3 with   points pt 2 lc 3 title "Thomasa",\
 'rozwSOR150.txt'  using 2:3 with  points pt 1 lc 2 title "SOR",\


set yrange [-0.1:1.1]
set xrange [-10:10]
set terminal png size 1366,768
set output "A_TS_Wykres2_i200.png"
...
plot 'rozwA200.txt'  using 2:3 with lines title "Analityczne",\
 'rozwT200.txt'  using 2:3 with   points pt 2 lc 3 title "Thomasa",\
 'rozwSOR200.txt'  using 2:3 with  points pt 1 lc 2 title "SOR",\
...
set xrange [-10:10]
set terminal png size 1366,768
set output "A_TS_Wykres2_i250.png"
...
plot 'rozwA250.txt'  using 2:3 with lines title "Analityczne",\
 'rozwT250.txt'  using 2:3 with   points pt 2 lc 3 title "Thomasa",\
 'rozwSOR250.txt'  using 2:3 with  points pt 1 lc 2 title "SOR",\
...
set xrange [-10:10]
set terminal png size 1366,768
set output "A_TS_Wykres2_i300.png"
...
plot 'rozwA300.txt'  using 2:3 with lines title "Analityczne",\
 'rozwT300.txt'  using 2:3 with   points pt 2 lc 3 title "Thomasa",\
 'rozwSOR300.txt'  using 2:3 with  points pt 1 lc 2 title "SOR",\
...
set xrange [-10:10]
set terminal png size 1366,768
set output "A_TS_Wykres2_i361.png"
...
plot 'rozwA361.txt'  using 2:3 with lines title "Analityczne",\
 'rozwT361.txt'  using 2:3 with   points pt 2 lc 3 title "Thomasa",\
 'rozwSOR361.txt'  using 2:3 with  points pt 1 lc 2 title "SOR",\
